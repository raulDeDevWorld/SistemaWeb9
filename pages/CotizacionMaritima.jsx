        ...
        <Layout>
            <div className={style.container}>
                <form className={style.form}>
                    ...
                    {
                        pdfData && pdfData["CM-SERVICIO"] && pdfData["CM-SERVICIO"] == "CM-PORTA CONTENEDORES" && <>
                            <br />
                    ...
                    {
                        pdfData && pdfData["CM-SERVICIO"] && pdfData["CM-SERVICIO"] !== "" && pdfData["CM-SERVICIO"] !== "CM-PORTA CONTENEDORES" && <>
                            <br />
